...
const evidence = z.object({
  ...
  smartscriptIds: z.array(z.string()).meta({
    description:
      'A list of smartscripts used to gather data from the user or to prepare the user for the process of gathering data.',
  }),
  dataSmartscriptId: z.string().meta({
    description:
      'The main data gathering smartscript autogenerated using the items listed in this evidence gatherer.',
  }),
});
