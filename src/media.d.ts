...
export type MediaResourceType = MediaUploadType | 'youtube' | 'vimeo' | 'googleMaps' | 'googleMapsDirections';
...
export type MediaVideo = Omit<MediaFile, 'resource_type'> & MediaStreamingProps & {
    resource_type: 'video';
};
export type MediaAudio = Omit<MediaFile, 'resource_type'> & MediaStreamingProps & {
    resource_type: 'video';
    is_audio: true;
};
...
export type MediaYoutube = Omit<MediaFile, 'resource_type'> & MediaStreamingProps & {
    resource_type: 'youtube';
};
export type MediaVimeo = Omit<MediaFile, 'resource_type'> & MediaStreamingProps & {
    resource_type: 'vimeo';
    hProp?: string;
};
...
export type Media = MediaImage | MediaVideo | MediaAudio | MediaPdf | MediaYoutube | MediaVimeo | MediaGoogleMap | MediaGoogleMapDirections;
