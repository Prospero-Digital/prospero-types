...
export type ActionType = 'action' | 'actor' | 'soundtrack' | 'decision' | 'random' | 'variable' | 'jumpTo' | 'clear' | 'end';
type ActionDefaults = Node & {
    section: 'action';
};
export type ActionActionTheme = 'default' | 'message' | 'news' | 'videoCall' | 'status' | 'email' | 'toolbar';
export type ActionActionButtonVariant = 'text' | 'outlined' | 'contained' | 'link';
export type ActionActionButtonColor = 'default' | 'inherit' | 'alternate' | 'primary' | 'secondary' | 'warning' | 'info' | 'error' | 'success';
...
export type Action = ActionAction | ActionActor | ActionEnd | ActionJumpTo | ActionRandom | ActionSoundtrack | ActionDecision;
export {};
